...
const uint8_t DAIKIN_TEMP_MIN = 10;
const uint8_t DAIKIN_TEMP_MAX = 30;
...
const uint8_t DAIKIN_LEADER_BITS = 5;
const uint32_t DAIKIN_LEADER_SPACE = 25000;
const uint32_t DAIKIN_BIT_THRESHOLD = (DAIKIN_ZERO_SPACE + DAIKIN_ONE_SPACE) / 2;
